...
class Companies::UsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create companies_user" do
    assert_difference('Companies::User.count') do
      post companies_users_url, params: { companies_user: { email: @companies_user.email, name: @companies_user.name, password: @companies_user.password } }
    end
  ...
  test "should update companies_user" do
    patch companies_user_url(@companies_user), params: { companies_user: { email: @companies_user.email, name: @companies_user.name, password: @companies_user.password } }
